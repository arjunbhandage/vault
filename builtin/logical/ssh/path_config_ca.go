...
func pathConfigCA(b *backend) *framework.Path {
	return &framework.Path{
		...
		Fields: map[string]*framework.FieldSchema{
			...
			"key_type": {
				Type:        framework.TypeString,
				Description: `Specifies the desired key type when generating; must be ssh-rsa, ecdsa-sha2-nistp256, ecdsa-sha2-nistp384, ecdsa-sha2-nistp521, or ssh-ed25519.`,
				Default:     "ssh-rsa",
			},
			"key_bits": {
				Type:        framework.TypeInt,
				Description: `Specifies the desired key bits when generating variable-length keys (currently ssh-rsa).`,
				Default:     0,
			},
		},
