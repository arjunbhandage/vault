module github.com/arjunbhandage/vault

go 1.17

replace github.com/arjunbhandage/vault/api => ./api

replace github.com/arjunbhandage/vault/api/auth/approle => ./api/auth/approle

replace github.com/arjunbhandage/vault/api/auth/userpass => ./api/auth/userpass

replace github.com/arjunbhandage/vault/sdk => ./sdk
...
require (
	...
	github.com/arjunbhandage/vault/api v1.3.1
	github.com/arjunbhandage/vault/api/auth/approle v0.1.0
	github.com/arjunbhandage/vault/api/auth/userpass v0.1.0
	github.com/arjunbhandage/vault/sdk v0.3.1-0.20220112143259-b48602fdb885
